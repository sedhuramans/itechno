...
export const ItechnoEventsData: EventDataType[] = [
  {
    ...
    feeDetails: 'Each participant needs to pay ₹100',
    time: '2–3 Hours',
    teamSize: 'Individual / 2–3 Participants (Team is optional)',
    ...
    rules: [
      ...
      'Team Size: Individual or Team of 2–3 Participants (Team is optional — solo participation is allowed).',
  ...
  },
  {
    ...
    fee: '💰 Registration Fee: ₹200 per Squad',
    feeDetails: '₹200 is the registration fee for one complete squad (not per participant). All members of the registered squad are covered.',
    time: 'As Scheduled',
    teamSize: 'Squad',
    location: 'Takshashila University, Ongur, Tamil Nadu, India',
    ...
    rules: [
      '💰 Registration Fee: ₹200 per Squad. ₹200 is the registration fee for one complete squad (The fee is NOT ₹200 per participant). All members of the registered squad are covered under the ₹200 squad registration fee.',
      '⚠️ IMPORTANT PARTICIPATION RULE: Anyone who registers for Free Fire – Squad Battle cannot participate in any other event. This restriction applies to every member of the Free Fire squad.',
      'A participant registered for Free Fire cannot participate in: Hackverse, Codeathon, Tech Battle, Word Battle, Pictonary, or Viral Minds.',
      'Team Size: Squad.',
