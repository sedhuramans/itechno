        ...
        >
          ...
          <div className="relative flex items-center justify-center">
            ...
            >
              ...
              {/* Percentage Text */}
              <div className="text-white text-3xl xs:text-3xl sm:text-4xl font-bold font-orbitron tracking-wider z-10 drop-shadow-[0_0_15px_rgba(255,255,255,0.7)] flex items-baseline">
          ...
          <div className="absolute bottom-12 sm:bottom-20 flex flex-col items-center gap-3 w-full max-w-sm px-6 sm:px-8">
